...
This file applies to all repositories under the **CalculabiliteEtComplexite** organization.  
...
Except where otherwise noted, all **original LaTeX teaching materials and the portions of the compiled PDFs that derive from them**
in this repository (slides, LaTeX sources/macros, etc.) are licensed under **CC BY-SA 4.0**.  
...
> © 2026 Matthieu Perrin, CC BY-SA 4.0, no changes."  
...
- `CM/src/img/Elements.jpg` — **Public domain**  
  <https://commons.wikimedia.org/wiki/File:P._Oxy._I_29.jpg>
- `CM/src/img/Frege.jpg` — **Public domain**  
...
- `CM/src/img/Rabin.jpg` — **CC BY-SA 2.0** (Konrad Jacobs)  
...
- `CM/src/img/Tablet.jpg` — **Public domain**  (grey background removed)
  <https://commons.wikimedia.org/wiki/File:Cuneiform_tablet-_administrative_account_with_entries_concerning_malt_and_barley_groats_MET_DP293245.jpg>
- `CM/src/img/Turing.jpg` — **Public domain**  
  <https://commons.wikimedia.org/wiki/File:Alan_Turing_(1951).jpg>
- `CM/src/img/vhs.jpg` — **CC BY-SA 2.5** (Toby Hudson, 2012)  
...
- `TD/src/img/logoUN.png` — **trademark** of Nantes Université  
...
- `CM/src/img/Strachey.jpg` — 
  <https://www.cs.man.ac.uk/CCS/res/res43.htm#e>

---

## Acknowledgments and Sources

Some teaching material in this organization (e.g. exercises, or code snippets) is **inspired by or adapted from**
external sources such as in textbooks or research articles on formal languages and the theory of computation.  
All material included here has been **translated, rewritten, or reformulated**, without verbatim reproduction  
of any protected content.

When a specific external source is closely followed, it is **explicitly acknowledged** in the header of the file  
or in a footnote within the corresponding PDF.
